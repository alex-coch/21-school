...
/** @brief Tests loading a model from a file.
 *
 *  @return void.
 */
START_TEST(parser_test) {
  ...
  for (int i = 0; i <= data->sum_facets; i++) {
...
/** @brief Tests rotating a model around the axis x.
 *
 *  @return void.
 */
...
/** @brief Tests rotating a model around the axis y.
 *
 *  @return void.
 */
...
/** @brief Tests rotating a model around the axis z.
 *
 *  @return void.
 */
...
/** @brief Tests scaling a matrix to coordinates.
 *
 *  @return void.
 */
...
/** @brief Tests moving a matrix to coordinates.
 *
 *  @return void.
 */
...
/** @brief Tests transfering a matrix to an array.
 *
 *  @return void.
 */
START_TEST(test_matrixToArray) {
  ...
  for (int i = 0; i < (data->sum_vertexes + 1) * 3; i++)
    if (data->array_3d[i] != expected_array[i]) count++;
...
/** @brief Tests transfering an array of structures an array.
 *
 *  @return void.
 */
