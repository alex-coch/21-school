...
START_TEST(s21_cosTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_cos(5 * S21_PI / 4), cos(5 * S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(4 * S21_PI / 3), cos(4 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(3 * S21_PI / 2), cos(3 * S21_PI / 2), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(5 * S21_PI / 3), cos(5 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(7 * S21_PI / 4), cos(7 * S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(11 * S21_PI / 6), cos(11 * S21_PI / 6), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(2 * S21_PI), cos(2 * S21_PI), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(11 * S21_PI / 17), cos(11 * S21_PI / 17), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(32 * S21_PI / 3), cos(32 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(-0), cos(-0), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(-S21_PI / 6), cos(-S21_PI / 6), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(-S21_PI / 4), cos(-S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_cos(-S21_PI / 2), cos(-S21_PI / 2), 1e-6);
...
START_TEST(s21_sinTEST) {
    ...
    ck_assert_ldouble_eq_tol(s21_sin(5 * S21_PI / 4), sin(5 * S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(4 * S21_PI / 3), sin(4 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(3 * S21_PI / 2), sin(3 * S21_PI / 2), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(5 * S21_PI / 3), sin(5 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(7 * S21_PI / 4), sin(7 * S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(11 * S21_PI / 6), sin(11 * S21_PI / 6), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(2 * S21_PI), sin(2 * S21_PI), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(11 * S21_PI / 17), sin(11 * S21_PI / 17), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(32 * S21_PI / 3), sin(32 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(-0), sin(-0), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(-S21_PI / 6), sin(-S21_PI / 6), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(-S21_PI / 4), sin(-S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_sin(-S21_PI / 2), sin(-S21_PI / 2), 1e-6);
...
START_TEST(s21_tanTEST) {
    ck_assert_ldouble_eq_tol(tan(-3 * S21_PI / 2), tan(-3 * S21_PI / 2), 1e-6);
    ...
    ck_assert_ldouble_eq_tol(s21_tan(5 * S21_PI / 4), tan(5 * S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(4 * S21_PI / 3), tan(4 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(5 * S21_PI / 3), tan(5 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(7 * S21_PI / 4), tan(7 * S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(11 * S21_PI / 6), tan(11 * S21_PI / 6), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(2 * S21_PI), tan(2 * S21_PI), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(11 * S21_PI / 17), tan(11 * S21_PI / 17), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(32 * S21_PI / 3), tan(32 * S21_PI / 3), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(-0), tan(-0), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(-S21_PI / 6), tan(-S21_PI / 6), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(-S21_PI / 4), tan(-S21_PI / 4), 1e-6);
    ck_assert_ldouble_eq_tol(s21_tan(-2 * S21_PI / 3), tan(-2 * S21_PI / 3), 1e-6);
